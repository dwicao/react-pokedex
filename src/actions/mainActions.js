...
export const fetchPokemon = offset => dispatch => {
  const noOffset = 'http://pokeapi.salestock.net/api/v2/pokemon-form/';
  const withOffset = `http://pokeapi.salestock.net/api/v2/pokemon-form/?offset=${offset}`;
...
export const fetchPokemonDetail = pokemonId => dispatch => {
  const uri = `http://pokeapi.salestock.net/api/v2/pokemon/${pokemonId}/`;
...
export const fetchPokemonByType = type => dispatch => {
  const uri = `http://pokeapi.salestock.net/api/v2/type/${type}/`;
